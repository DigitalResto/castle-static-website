...
const menuData = {
  ...
  items: [
    ...
    { _id: "s2", categoryId: "1", name: "Clear Soup", price: "90/130", variants: "Veg/Non-Veg" },
    { _id: "s3", categoryId: "1", name: "Hot & Sour", price: "90/130", variants: "Veg/Non-Veg" },
    { _id: "s4", categoryId: "1", name: "Manchow", price: "90/130", variants: "Veg/Non-Veg" },
    { _id: "s5", categoryId: "1", name: "Noodle Soup", price: "90/130", variants: "Veg/Non-Veg" },
    { _id: "s6", categoryId: "1", name: "Pepper Soup", price: "90/130", variants: "Veg/Non-Veg" },
    { _id: "s7", categoryId: "1", name: "Sweet Corn", price: "90/130", variants: "Veg/Non-Veg" },
    { _id: "s8", categoryId: "1", name: "Cream of Mushroom", price: 100 },
    { _id: "s9", categoryId: "1", name: "Cream of Tomato", price: 100 },
    { _id: "s10", categoryId: "1", name: "Dragon Soup", price: "100/130", variants: "Veg/Non-Veg" },
    { _id: "s11", categoryId: "1", name: "Lemon Coriander Soup", price: "100/130", variants: "Veg/Non-Veg" },
    { _id: "s12", categoryId: "1", name: "Lung Fung", price: 120 },
    { _id: "s13", categoryId: "1", name: "Sea Food Soup", price: 130 },

    // SALADS
    { _id: "sal1", categoryId: "2", name: "Hummus", price: "50/130/200", variants: "Small/Medium/Large" },
    { _id: "sal2", categoryId: "2", name: "Thoum (Garlic Mayo)", price: "30/70/130", variants: "Small/Medium/Large" },
    ...
    { _id: "sh6", categoryId: "3", name: "Chicken Shawarma Rumali Roll", price: 90 },
    { _id: "sh7", categoryId: "3", name: "Special Shawarma Roll (Whole Meat)", price: 110 },
    { _id: "sh8", categoryId: "3", name: "Chicken Cheese Shawarma Roll", price: 130 },
    { _id: "sh9", categoryId: "3", name: "Jumbo Shawarma Roll (Rumali)", price: 110 },
    { _id: "sh10", categoryId: "3", name: "Tawa Chicken Roll", price: 100 },
    { _id: "sh11", categoryId: "3", name: "Hummus Falafel Plate", price: 140 },
    { _id: "sh12", categoryId: "3", name: "Chicken Shawarma Plate", price: 140 },
    { _id: "sh13", categoryId: "3", name: "Mexican Shawarma Plate", price: 150 },
    { _id: "sh14", categoryId: "3", name: "Special Shawarma Plate (Whole Meat)", price: 160 },
    ...
    // ANDHRA STARTERS
    { _id: "ast1", categoryId: "5", name: "Guntur Chicken Dry (B/L)", price: 300 },
    { _id: "ast2", categoryId: "5", name: "Andhra Pepper Chicken Dry (B/L)", price: 290 },
    { _id: "ast3", categoryId: "5", name: "Butterfly Chicken (B/L)", price: 330, isChefSpecial: true },
    { _id: "ast4", categoryId: "5", name: "Saute Chicken Dry (B/L)", price: 280 },
    { _id: "ast5", categoryId: "5", name: "Bhuna Chicken", price: 280 },
    { _id: "ast6", categoryId: "5", name: "Andhra Style Lemon Chicken (B/L)", price: 270 },
    ...
    { _id: "csp2", categoryId: "6", name: "Castle Spl Chicken Masala", price: 360 },
    { _id: "csp3", categoryId: "6", name: "Tandoori Veg Platter", price: 699 },
    { _id: "csp4", categoryId: "6", name: "Dajaj Tikki Platter", price: 799 },
    { _id: "csp5", categoryId: "6", name: "Tawa Mushakkal Mini Platter", price: 899 },
    { _id: "csp6", categoryId: "6", name: "Barbeque Mini Platter", price: 899 },
    { _id: "csp7", categoryId: "6", name: "Chinese Non Veg Platter", price: 999 },
    { _id: "csp8", categoryId: "6", name: "Arabian Mini Sea Food Special Platter", price: 1099 },
    { _id: "csp9", categoryId: "6", name: "Tandoori Non Veg Platter", price: 1199 },
    { _id: "csp10", categoryId: "6", name: "Castle Spl Family Biriyani Combo", price: 1249 },
    { _id: "csp11", categoryId: "6", name: "Barbeque Family Platter", price: 1499 },
    { _id: "csp12", categoryId: "6", name: "Tawa Mushakkal Platter", price: 1599, isChefSpecial: true },
    { _id: "csp13", categoryId: "6", name: "Arabian Sea Food Special Platter", price: 1799 },

    // INDIAN STARTERS
    { _id: "is1", categoryId: "7", name: "Chicken Kebab 12/6", price: "330/170" },
    ...
    { _id: "gb3", categoryId: "8", name: "Masala Shaway", price: "460/240/125" },
    { _id: "gb4", categoryId: "8", name: "Green Chilly Shaway", price: "480/250/130" },
    { _id: "gb14", categoryId: "8", name: "Green Chilly BBQ Chicken", price: "480/250/130" },
    { _id: "gb15", categoryId: "8", name: "Badami BBQ Chicken", price: "480/260/140" },
    { _id: "gb16", categoryId: "8", name: "Castle Spl Barbeque Chicken", price: "480/240/140", isChefSpecial: true },
    { _id: "gb17", categoryId: "8", name: "Peri Peri Barbeque Chicken", price: "490/260/140" },
    { _id: "gb18", categoryId: "8", name: "Morocan BBQ Chicken", price: "500/270/140", isChefSpecial: true },
    { _id: "gb19", categoryId: "8", name: "Mutton Chops", price: 499 },
    { _id: "gb20", categoryId: "8", name: "Barbeque Pomfret", price: "AS PER SIZE" },
    { _id: "gb21", categoryId: "8", name: "Barbeque King Fish", price: "AS PER SIZE" },
    ...
    { _id: "th11", categoryId: "9", name: "Tandoori Chicken", price: "380/190", variants: "Full/Half" },
    ...
    { _id: "ths3", categoryId: "10", name: "Tandoori Pomfret", price: "AS PER SIZE" },
    ...
    { _id: "atn2", categoryId: "12", name: "Clope Meshwi", price: 340, isChefSpecial: true },
    { _id: "atn3", categoryId: "12", name: "Mexican Dajaj Meshwi", price: 340 },
    { _id: "atn4", categoryId: "12", name: "Dajaj Honey Kebab", price: 360 },
    { _id: "atn5", categoryId: "12", name: "Green Chilli Kebab", price: 360, isChefSpecial: true },
    { _id: "atn6", categoryId: "12", name: "Iffa Dajaj", price: 360, isChefSpecial: true },
    { _id: "atn7", categoryId: "12", name: "Lebanese Dajaj Meshwi", price: 380 },
    ...
    { _id: "ats8", categoryId: "13", name: "Stuffed Tawa Prawns", price: 700, isChefSpecial: true },
    ...
    // MANDI & ARABIC RICE
    { _id: "mar1", categoryId: "15", name: "Chicken Mandi", price: "740/380/200" },
    { _id: "mar2", categoryId: "15", name: "Mandi Rice", price: 100 },
    { _id: "mar3", categoryId: "15", name: "Kozi Rice", price: 100 },
    { _id: "mar4", categoryId: "15", name: "Arabic Shawaya Mandi", price: "780/400/200" },
    { _id: "mar5", categoryId: "15", name: "Green Chilly Shaway Mandi", price: "800/420/220" },
    { _id: "mar6", categoryId: "15", name: "Mutton Mandi", price: "1300/660/340" },

    // INDIAN BIRIYANI & RICE
    { _id: "ibr1", categoryId: "16", name: "Hyderabadi Family Chicken Biriyani", price: "370/560/750" },
    { _id: "ibr2", categoryId: "16", name: "Malabar Family Chicken Biriyani", price: "330/500/670" },
    { _id: "ibr3", categoryId: "16", name: "Hyderabadi Family Mutton Biriyani", price: "550/830/1100" },
    { _id: "ibr4", categoryId: "16", name: "Malabar Family Mutton Biriyani", price: "530/800/1050" },

    // CHINESE NON VEG
    { _id: "cnv1", categoryId: "17", name: "Chicken Manchurian", price: "220/240", variants: "Dry/Gravy" },
    { _id: "cnv2", categoryId: "17", name: "Chilly Chicken", price: "220/240", variants: "Dry/Gravy" },
    { _id: "cnv3", categoryId: "17", name: "Ginger Chicken", price: "220/240", variants: "Dry/Gravy" },
    { _id: "cnv4", categoryId: "17", name: "Garlic Chicken", price: "220/240", variants: "Dry/Gravy" },
    { _id: "cnv5", categoryId: "17", name: "Lemon Chicken", price: "220/240", variants: "Dry/Gravy" },
    { _id: "cnv6", categoryId: "17", name: "Schezwan Chicken", price: "220/240", variants: "Dry/Gravy" },
    ...
    { _id: "cnv12", categoryId: "17", name: "Thai Chicken", price: 270, isChefSpecial: true },
    { _id: "cnv13", categoryId: "17", name: "Spanish Chicken", price: 270, isChefSpecial: true },
    { _id: "cnv14", categoryId: "17", name: "Peri Peri Chicken", price: 280, isChefSpecial: true },
    { _id: "cnv15", categoryId: "17", name: "Lamb in Oyster Sauce", price: 320 },
    { _id: "cnv16", categoryId: "17", name: "Lamb in Butter Garlic", price: 340 },

    // SEA FOOD CHINESE
    { _id: "sfc1", categoryId: "18", name: "Fish Manchurian", price: "260/270", variants: "Dry/Gravy" },
    { _id: "sfc2", categoryId: "18", name: "Fish Chilly", price: "260/270", variants: "Dry/Gravy" },
    { _id: "sfc3", categoryId: "18", name: "Prawn Manchurian", price: "280/290", variants: "Dry/Gravy" },
    { _id: "sfc4", categoryId: "18", name: "Prawn Chilly", price: "280/290", variants: "Dry/Gravy" },
    { _id: "sfc5", categoryId: "18", name: "Prawn in Butter Garlic", price: 300 },
    { _id: "sfc6", categoryId: "18", name: "Fish Finger", price: 300 },
    { _id: "sfc7", categoryId: "18", name: "Golden Fried Prawn", price: 320 },
    { _id: "sfc8", categoryId: "18", name: "Singapore Chilly Crab", price: 320, isChefSpecial: true },
    { _id: "sfc9", categoryId: "18", name: "Singapore Chilly Tiger Prawn", price: 420, isChefSpecial: true },

    // VEG CHINESE
    { _id: "vc1", categoryId: "19", name: "French Fries", price: 110 },
    { _id: "vc2", categoryId: "19", name: "Dragon Potato", price: 130 },
    { _id: "vc3", categoryId: "19", name: "Mushroom Manchurian", price: "130/150", variants: "Dry/Gravy" },
    { _id: "vc4", categoryId: "19", name: "Mushroom Chilly", price: "130/150", variants: "Dry/Gravy" },
    { _id: "vc5", categoryId: "19", name: "Baby Corn Manchurian", price: "130/150", variants: "Dry/Gravy" },
    ...
    { _id: "br18", categoryId: "20", name: "Stuffed Paratha (Aloo/Gobi/Paneer)", price: 50 },
    { _id: "br19", categoryId: "20", name: "Kashmiri Naan", price: 60 },

    // INDIAN CURRYS VEG
    { _id: "icv1", categoryId: "21", name: "Veg Kadai", price: 160 },
    { _id: "icv2", categoryId: "21", name: "Veg Kolapuri", price: "100/150", variants: "Half/Full" },
    { _id: "icv3", categoryId: "21", name: "Green Peas Masala", price: "100/150", variants: "Half/Full" },
    { _id: "icv4", categoryId: "21", name: "Mixed Veg Curry", price: "100/150", variants: "Half/Full" },
    { _id: "icv5", categoryId: "21", name: "Mushroom Masala", price: "110/160", variants: "Half/Full" },
    ...
    { _id: "icv12", categoryId: "21", name: "Paneer Butter Masala", price: "140/200", variants: "Half/Full" },
    { _id: "icv13", categoryId: "21", name: "Paneer Tikka Masala", price: "140/200", variants: "Half/Full" },
    { _id: "icv14", categoryId: "21", name: "Kadai Paneer", price: 200 },
    { _id: "icv15", categoryId: "21", name: "Malai Kofta", price: 170 },
    { _id: "icv16", categoryId: "21", name: "Paneer Kurchan", price: 200, isChefSpecial: true },
    ...
    // MILKSHAKES & MOJITO
    { _id: "mm1", categoryId: "23", name: "Milkshakes Varieties", price: "89-129", description: "Various flavors available" },
    { _id: "mm2", categoryId: "23", name: "Mojito Varieties", price: "130-150", description: "Various flavors available" },

    // FALOODA & ICE CREAMS
    { _id: "fi1", categoryId: "24", name: "Falooda Varieties", price: "100-250", description: "Various flavors available" },
    { _id: "fi2", categoryId: "24", name: "Ice Cream Varieties", price: "80-120", description: "Various flavors available" },
    ...
    { _id: "fc4", categoryId: "25", name: "Dry Fruit Cream", price: 240, isChefSpecial: true },
